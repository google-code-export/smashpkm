...
<html>
    <head>
        ...
        <title>Daftar Beasiswa-SMASH</title>
    ...
    <body>
        ...
        <div id="templatemo_wrapper">
            ...
            <div id="templatemo_main">
                    ...
                    <form method='post' action="DispatcherBeasiswa?page=daftarBeasiswa">
                        <table border=0>
                            <tr>
                                ...
                                <td>
                                    <input type="submit" class="submit_btn float_l" name="submit" id="submit" value="Apply"  />
                                </td>
                            </tr>
                        </table>
                    </form>
                ...
                <br/><br/>
                <font color="black">Record permohonan beasiswa yang telah diajukan:</font>
                <br/>
                <table border="1">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <font color="black">Beasiswa</font>
                            </th>
                            <th>
                                <font color="black">Tanggal pengajuan</font>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <c:forEach items="${list_pengajuan_by_nrp}" var="bsw">
                            ...
                            <tr>
                                <td>
                                    <font color="black"><%out.print(i);%></font>
                                    <%i++;%>
                                </td>
                                <td>
                                    <font color="black">${bsw.idbeasiswa.namabeasiswa}</font>
                                </td>
                                <td>
                                    <font color="black">${bsw.tanggalpengajuan}</font>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
