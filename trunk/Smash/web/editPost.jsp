                        ...
                        <form method='post' action='DispatcherBeasiswa?page=goEditPost&&idbeasiswa=${beasiswa.idbeasiswa}'>
                            <table align="left">
                                <tr>
                                    ...
                                    <td>
                                        : <input id="demo1" type="text" name="tanggalpublish" size="15" disabled="disabled" value="${tanggalpublish}"><a href="javascript:NewCal('demo1','ddmmyyyy')"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"/></a></input>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        : <input id="demo2" type="text" name="tanggalkadaluwarsa" size="15" disabled="disabled" value="${tanggalkadaluwarsa}"><a href="javascript:NewCal('demo2','ddmmyyyy')"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"/></a></input>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        : <input id="demo3" type="text" name="tanggalmulai" size="15" disabled="disabled" value="${tanggalmulai}"><a href="javascript:NewCal('demo3','ddmmyyyy')"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"/></a></input>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        : <input id="demo4" type="text" name="tanggalhabis" size="15" disabled="disabled" value="${tanggalhabis}"><a href="javascript:NewCal('demo4','ddmmyyyy')"><img src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date"/></a></input>
                                    </td>
                                </tr>
                            </table>
